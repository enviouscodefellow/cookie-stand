...
locationsObjects[0].getCusts();
locationsObjects[0].getSales();
locationsObjects[0].getHourlyCookies();
locationsObjects[0].getDailyCustTotal();
locationsObjects[0].getDailySalesTotal();
locationsObjects[0].render();
